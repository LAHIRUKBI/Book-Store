...
export default function Admin_Login() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-900 via-gray-900 to-black text-white">
      {/* Login Container */}
      <div className="flex space-x-12 w-full max-w-7xl justify-center">
        {/* Admin Login Form */}
        <div className="w-full max-w-md p-8 bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-3xl text-center font-semibold mb-6 text-cyan-400 flex items-center justify-center">
          ...
          <form onSubmit={handleAdminLogin}>
            ...
            <button
              type="submit"
              className="w-full p-3 bg-cyan-600 text-white rounded-md hover:bg-cyan-700 focus:outline-none flex items-center justify-center"
            >
        ...
        {/* Company Login Form */}
        <div className="w-full max-w-md p-8 bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-3xl text-center font-semibold mb-6 text-green-400 flex items-center justify-center">
          ...
          <form onSubmit={handleCompanyLogin}>
            ...
            <button
              type="submit"
              className="w-full p-3 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none flex items-center justify-center"
            >
